# The EloAI Annotation Handbook — Facets, Meta & EPA

> A plain-language guide to the meaning layer on the dictionary: what every term
> means, **how to read the rating numbers** (e.g. `+1`, `-0.3`), and **how to adjust
> things to get the result you want**. Written for anyone labeling the gold set,
> writing overrides, or reading the compressed output — no deep code needed.
>
> *File paths below are relative to the `semantic_compression/` project root.*
> Deeper specs: `docs/compression/spec-facets-db.md`, `docs/compression/spec-meta-db.md`,
> `../Memory/mneme/docs/EPA.md`.
...
```
Terms / record   docs/compression/spec-facets-db.md (facet) ; docs/compression/spec-meta-db.md (meta)
Accuracy         docs/compression/spec-facet-accuracy.md ; harness: facet_accuracy.py
EPA              ../Memory/mneme/docs/EPA.md ; ../Memory/mneme/docs/spec-epa-expansion.md ;
                 ../Memory/mneme/docs/spec-epa-substrate.md
Labeling rubric  docs/compression/spec-facet-accuracy.md §3 ; gold: data/facet_gold*.tsv
